...
import { Bot } from 'lucide-react'; // Using the 'Bot' icon for Discord
...
export const DiscordNode = memo(({ data, selected }: DiscordNodeProps) => {
  return (
    <div className={cn(
      "px-3 py-1.5 shadow-md rounded-md bg-card border border-indigo-500 min-w-[150px]", // Discord-like color
      data.isRunning ? 'ring-2 ring-offset-2 ring-indigo-500 ring-offset-white' : '',
